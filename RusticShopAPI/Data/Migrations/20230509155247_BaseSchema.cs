        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Carts_Quantity_Range", "[Quantity] >= 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ProductVariantDiscounts_EndDate_Range", "[EndDate] > [StartDate]");
                    table.CheckConstraint("CK_ProductVariantDiscounts_Percentage_Range", "[Percentage] >= 0.01 AND [Percentage] <= 1.00");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Wishlists", x => new { x.ProductVariantId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderDetails_Quantity_Range", "[Quantity] >= 1");
                    table.CheckConstraint("CK_OrderDetails_UnitPrice_Range", "[UnitPrice] > 0");
                    table.ForeignKey(
